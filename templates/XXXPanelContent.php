 ...
 * for an <em><b>XXX user type</b></em> page.  The content generated is intended for 3 panel
 * view layouts. 
 * 
 * To use this TEMPLATE - change 'XXXPanelContent' to the required usertype and userfunction everywhere it appears 
 *  
 * eg: if you want to define a model for MyAccount functions for user type 'supplier'
 * <ul>
 * <li>Rename this file - replace the 'XXXPanelContent' with 'SupplierMyAccount' in the file name </li>
 * <li>Rename class  - replace the 'XXXPanelContent' with 'SupplierMyAccount' as the class name </li>
 * <li>Edit this file to REPLACE ALL remaining 'XXXPanelContent' in this file with 'supplierMyAccount' </li>
...
class XXXPanelContent extends PanelModel{
    ...
    */  
    ...
    public function setPanelContent_1(){
        $this->panelContent_1='<p>You are accessing the '.$this->modelType.' Panel Model Class';
    }      
