...
include_once 'classlib/entities/ProductsTable.php';
include_once 'classlib/entities/ProductCategoriesTable.php';
include_once 'classlib/entities/ProductBrandsTable.php';
include_once 'classlib/entities/CartTable.php';
include_once 'classlib/entities/OrdersTable.php';
include_once 'classlib/entities/WishlistTable.php';
...
include_once 'models/panelContent/AdminManageProducts.php';
...
include_once 'models/panelContent/CustomerViewProducts.php';
