<?php
/**
* This file contains the CustomerShoppingCart Class
* 
*/


/**
 * CustomerShoppingCart is an extended PanelModel Class
 * 
...
class CustomerShoppingCart extends PanelModel {
  
    /**
    * Constructor Method
    * 
    * The constructor for the PanelModel class. The CustomerShoppingCart class provides the 
    ...
    */  
    function __construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID){  
        $this->modelType='CustomerShoppingCart';
