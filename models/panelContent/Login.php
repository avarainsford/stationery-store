    ...
    public function setPanelContent_2(){ 
        ...
        if(isset($this->postArray['btnLogin'])){  //check that the login button is pressed
            ...
            if(!$this->loggedin){  //if login is not successful keep track of login attempts
                ...
                //lock out
                if($this->user->getLoginAttempts()>3){
                $this->panelContent_2='<b style = "color: red; font-size: large;">Account locked, too many login attempts.</b>';
                $this->panelContent_2.='<br><b>Please return to landing page.</b>';
                }
                else{
